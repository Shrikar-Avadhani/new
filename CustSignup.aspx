					...
					<form runat="server" action="#" method="post" class="w3_form_post">
						...
						<div class="w3_agileits_main_grid w3l_main_grid">
							...
							<span class="agileits_grid">
								...
								<input runat="server" id="Lcode" type="text" name="Lcode" placeholder="Location Code" required="" pattern="[0-9]{7}" title ="Enter 7 Digits only"/>
							</span>
						</div>
							...
							<span class="agileits_grid">
								...
								<input runat="server" id="Uname" type="text" name="Uname" placeholder="Username" required=""/>
							</span>
						</div>
							<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								<label for="Password">Password<span class="star">*</span></label>
								<input runat="server" id="Password" type="Password" name="Password" placeholder="Password" required=""/>
							</span>
								</div>
								<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
