    ...
    <div class="form">
        <form runat="server" method="post">
            <div class="form-group">
                ...
                <input runat="server" type="text" placeholder="Enter Your Name" id="Name" required="">
            ...
            <div class="form-group">
                ...
                <input runat="server" type="text" placeholder="Enter Mobile No." id="Mobile" required="">
            ...
            <div class="form-group">
                ...
                <input runat="server" type="text" placeholder="Enter your email id" id="Email" required="">
            ...
            <div class="form-group">
                ...
                <textarea style="border-bottom:4px solid black; border-radius:5px; resize:none;" runat="server" cols="28" type="text" placeholder="Enter your Address" id="Address" required=""></textarea>
            ...
            <div class="form-group">
                ...
                <input runat="server" type="text" placeholder="Enter your Aadhar Number" id="Aadhar" required="">
            </div>
            <div class="form-group">
                <label runat="server" for="Username">Username</label>
                <input runat="server" type="text" placeholder="Enter Username" id="Username" required="">
            ...
            <div class="form-group">
                ...
                <input runat="server" type="text" placeholder="Enter Password" id="Password" required="">
