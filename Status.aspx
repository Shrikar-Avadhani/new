...
width: 500px; padding:30px;">Name:
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:UEBConnectionString18 %>" SelectCommand="SELECT [Name], [Address], [Email], [Mobile_No], [Aadhar_No] FROM [tblNewConnection] WHERE ([Mobile_No] = @Mobile_No)">
        <SelectParameters>
