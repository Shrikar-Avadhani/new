...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:UEBConnectionString13 %>" SelectCommand="SELECT * FROM [tblDelCust]"></asp:SqlDataSource>
</form>
</asp:Content>
