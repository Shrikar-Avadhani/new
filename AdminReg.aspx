			...
			<div class="w3layouts-main">
				<h2 style="text-decoration:underline;"><span>Register A New Admin</span></h2>
					<form runat="server" action="#" method="post">
						<input runat="server" id="Name" placeholder="Name" name="Name" type="text" required="" pattern="[a-zA-Z]{3,23}" title="Enter more than 3 and less than 23 characters"/>
						...
						<input runat="server" id="Aadhar" placeholder="Aadhaar No." name="Aadhaar" type="text" required="" pattern="[0-9]{12}" title="Enter 12 digits only"/>
						<input runat="server" id="Username" placeholder="Username" name="Username" type="text" required=""/>
						<input runat="server" id="Password" placeholder="Password" name="Password" type="password"/>
